...
Usage:
  ...
  uv run python -m src.h3.load_h3_r8_to_psql --dry-run  # Show what would be done
...
Prerequisites:
  ...
  - Parquet files exist: data/processed/ghsl_h3_r8/h3_r8_pop_*.parquet
...
# Data paths
INPUT_DIR = Path("data/processed/ghsl_h3_r8")

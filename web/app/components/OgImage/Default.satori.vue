...
/**
 * Default OG image template for the home page / site-wide fallback.
 *
 * Branded hero: the Urban World mark + wordmark (large) over the parchment
